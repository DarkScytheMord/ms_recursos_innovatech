...
## Postman
Se incluye una coleccion y un environment:
- `postman/ms_recursos_innovatech.postman_collection.json`
- `postman/ms_recursos_innovatech.postman_environment.json`

### Como usar
1. Importa ambos archivos en Postman.
2. Selecciona el environment `ms_recursos_innovatech`.
3. Asegura que `baseUrl` apunte a tu servidor (por defecto `http://localhost:8080`).
4. Ejecuta las requests en orden: crea profesional y habilidad, luego relaciona y crea disponibilidad, asignaciones y ausencias.
